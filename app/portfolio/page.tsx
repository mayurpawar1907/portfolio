...
const cardData = [
  {
    title: "",
    image:
      "https://www.digitalsilk.com/wp-content/uploads/2025/01/remax-left-with-background-new.jpg",
  },
  {
    title: "",
    image:
...
const partnerLogos = [
  ...
  {
    src: "https://www.digitalsilk.com/wp-content/uploads/2024/05/xerox_logo-1.png",
    alt: "Quora",
  },
  {
    src: "https://www.digitalsilk.com/wp-content/uploads/2024/05/grenco_logo-1.png",
  ...
  {
    src: "https://www.digitalsilk.com/wp-content/uploads/2024/05/mcds_logo-1.png",
    alt: "Samsung",
  },
  {
    src: "https://www.digitalsilk.com/wp-content/uploads/2024/05/nyc_logo-1.png",
    alt: "Quora",
  },
];
...
`,
      ...
      `}</style>
        ...
        <div className="reverse-slider-wrapper">
  <div className="reverse-slider-track">
    {boxes}
  </div>
</div>
        ...
        <div className="container px-4 md:px-6">
          <ScrollAnimation type="fade-up">
            <div className="flex flex-col items-center space-y-6 text-center">
              ...
              <Button
                asChild
                className="bg-purple-600 hover:bg-purple-700 border-0 text-white px-8 py-4"
              >
